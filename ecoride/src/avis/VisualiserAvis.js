    ...
    const fetchReservations = async () => {
      ...
      try {
        const response = await axios.get(
          `https://api-ecride-production.up.railway.app/Controllers/ReservationController.php?utilisateur_id=${utilisateurId}`,
      ...
      const fetchData = async () => {
        ...
        try {
          ...
          const creatorResponse = await axios.get(
            `https://api-ecride-production.up.railway.app/Controllers/TrajetController.php?trajet_id=${selectedTrajet.trajet_id}`,
            { withCredentials: true, headers: { 'Content-Type': 'application/json' } }
          );
          ...
          const avisResponse = await axios.get(
            `https://api-ecride-production.up.railway.app/Controllers/AvisController.php?trajet_id=${selectedTrajet.trajet_id}`,
            { withCredentials: true, headers: { 'Content-Type': 'application/json' } }
          );
                        ...
                        <button
                          ...
                          onClick={async () => {
                            if (window.confirm("Êtes-vous sûr de vouloir annuler cette réservation ?")) {
                              try {
                                await axios.delete(
                                  `https://api-ecride-production.up.railway.app/Controllers/ReservationController.php?reservation_id=${trajet.reservation_id}`,
                                  { withCredentials: true, headers: { 'Content-Type': 'application/json' } }
                                );
