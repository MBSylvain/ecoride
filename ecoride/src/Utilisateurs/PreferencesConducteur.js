...
const PreferencesConducteur = () => {
  ...
  const fetchPreferences = async () => {
    ...
    try {
      const response = await axios.get(
        `https://api-ecride-production.up.railway.app/Controllers/PreferenceConducteurController.php?utilisateur_id=${utilisateur_id}`,
        {
  ...
  const handleDelete = async (preference_id) => {
    ...
    try {
      await axios.delete(
        `https://api-ecride-production.up.railway.app/Controllers/PreferenceConducteurController.php?preference_id=${preference_id}`,
        { withCredentials: true }
      );
  ...
  const handleSave = async (preference_id) => {
    try {
      await axios.put(
        `https://api-ecride-production.up.railway.app/Controllers/PreferenceConducteurController.php`,
