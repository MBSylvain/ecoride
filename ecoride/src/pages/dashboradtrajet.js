...
const TripForm = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://api-ecride-production.up.railway.app/Controllers/VoitureController.php?utilisateur_id=${utilisateur_id}`)
      .then((res) => res.json())
    ...
    if (trajet_id) {
      setIsEdit(true);
      fetch(`https://api-ecride-production.up.railway.app/Controllers/TrajetController.php?trajet_id=${trajet_id}`)
        .then((res) => res.json())
        .then((data) => {
          setForm({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://api-ecride-production.up.railway.app/Controllers/TrajetController.php", {
        method: "POST",
