...
const DashboardReservations = () => {
  ...
  const fetchReservations = async () => {
    ...
    if (searchParams.get("reservation_id")) {
      ...
      const res = await fetch(`https://api-ecride-production.up.railway.app/Controllers/ReservationController.php?reservation_id=${id}&utilisateur_id=${utilisateur_id}`);
    ...
    if (searchParams.get("trajet_id")) {
      ...
      const res = await fetch(`https://api-ecride-production.up.railway.app/Controllers/ReservationController.php?trajet_id=${id}&utilisateur_id=${utilisateur_id}`);
      const data = await res.json();
      if (data.error) {
        setMessage(data.error);
        setMessageType("danger");
    ...
    const res = await fetch(`https://api-ecride-production.up.railway.app/Controllers/ReservationController.php?utilisateur_id=${utilisateur_id}`);
    const data = await res.json();
    setReservations(data.reservations || []);
    setLoading(false);
  };
  ...
  const handleAction = async (action, id) => {
    ...
    setMessage("");
    setMessageType("");
    const res = await fetch(`https://api-ecride-production.up.railway.app/Controllers/ReservationController.php`, {
      method: "POST",
