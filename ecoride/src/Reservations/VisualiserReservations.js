...
const VisualiserReservations = () => {
    ...
    const fetchReservations = async () => {
      ...
      try {
        const response = await axios.get(
          `https://api-ecride-production.up.railway.app/Controllers/ReservationController.php?utilisateur_id=${utilisateur_id}`,
  ...
  useEffect(() => {
    if (selectedReservation) {
      ...
      axios.get(
        `https://api-ecride-production.up.railway.app/Controllers/UtilisateurController.php?utilisateur_id=${selectedReservation.utilisateur_id}`,
        { withCredentials: true, headers: { 'Content-Type': 'application/json' } }
      )
        .then((res) => {
