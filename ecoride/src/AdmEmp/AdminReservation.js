...
const AdminReservation = () => {
  ...
  const fetchReservations = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://api-ecride-production.up.railway.app/ControllersAdministrateur/ReservationAdminController.php", {
  ...
  const handleSaveReservation = async (reservation) => {
    try {
      if (reservation.reservation_id) {
        await axios.put("https://api-ecride-production.up.railway.app/ControllersAdministrateur/ReservationAdminController.php", reservation, {
          withCredentials: true,
          headers: { "Content-Type": "application/json" }
        });
        setFeedback("Réservation modifiée !");
      } else {
        await axios.post("https://api-ecride-production.up.railway.app/ControllersAdministrateur/ReservationAdminController.php", reservation, {
          withCredentials: true,
          headers: { "Content-Type": "application/json" }
        });
  ...
  const handleDeleteReservation = async (reservationId) => {
    try {
      await axios.delete(`https://api-ecride-production.up.railway.app/ControllersAdministrateur/ReservationAdminController.php?reservation_id=${reservationId}`, {
        withCredentials: true,
        headers: { "Content-Type": "application/json" }
      });
