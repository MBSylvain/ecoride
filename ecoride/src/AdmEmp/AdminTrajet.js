...
const AdminTrajet = () => {
  ...
  const fetchTrajets = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://api-ecride-production.up.railway.app/ControllersAdministrateur/TrajetAdminController.php", {
  ...
  const handleSaveTrajet = async (trajet) => {
    try {
      if (trajet.trajet_id) {
        await axios.put("https://api-ecride-production.up.railway.app/ControllersAdministrateur/TrajetAdminController.php", trajet, {
          withCredentials: true,
          headers: { "Content-Type": "application/json" }
        });
        setFeedback("Trajet modifié !");
      } else {
        await axios.post("https://api-ecride-production.up.railway.app/ControllersAdministrateur/TrajetAdminController.php", trajet, {
          withCredentials: true,
          headers: { "Content-Type": "application/json" }
        });
  ...
  const handleDeleteTrajet = async (trajetId) => {
    try {
      await axios.delete(`https://api-ecride-production.up.railway.app/ControllersAdministrateur/TrajetAdminController.php?trajet_id=${trajetId}`, {
        withCredentials: true,
        headers: { "Content-Type": "application/json" }
      });
