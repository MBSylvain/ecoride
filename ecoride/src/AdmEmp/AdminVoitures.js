...
const AdminVoitures = () => {
  ...
  const fetchVoitures = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://api-ecride-production.up.railway.app/api/ControllersAdministrateur/VoitureAdminController.php", {
  ...
  const handleSaveVoiture = async (voiture) => {
    try {
      if (voiture.voiture_id) {
        await axios.put("https://api-ecride-production.up.railway.app/api/ControllersAdministrateur/VoitureAdminController.php", voiture, {
          withCredentials: true,
          headers: { "Content-Type": "application/json" }
        });
        setFeedback("Voiture modifiée !");
      } else {
        await axios.post("https://api-ecride-production.up.railway.app/api/ControllersAdministrateur/VoitureAdminController.php", voiture, {
          withCredentials: true,
          headers: { "Content-Type": "application/json" }
        });
  ...
  const handleDeleteVoiture = async (voitureId) => {
    try {
      await axios.delete(`https://api-ecride-production.up.railway.app/api/ControllersAdministrateur/VoitureAdminController.php?voiture_id=${voitureId}`, {
        withCredentials: true,
        headers: { "Content-Type": "application/json" }
      });
